...
fn create_filesystem_args(
    ...
    for writable_root in &sorted_writable_roots {
        ...
        let mut read_only_subpaths: Vec<PathBuf> = writable_root
            ...
            .collect();
        let preserved_path_names =
            preserved_path_names_for_writable_root(file_system_sandbox_policy, writable_root, cwd);
        append_preserved_path_masks_for_writable_root(
...
fn append_preserved_path_masks_for_writable_root(
